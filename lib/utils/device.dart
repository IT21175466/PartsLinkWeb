...
class DeviceUtils {
  ...
  static double getWidthFactor(BuildContext context) =>
      MediaQuery.of(context).size.width * Dimens.widthFactor;

  static double getHeightFactor(BuildContext context) =>
      MediaQuery.of(context).size.height * Dimens.heightFactor;
}
