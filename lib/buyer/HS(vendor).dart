...
import 'package:gap/buyer/N(vendor).dart';
...
class venSellingsPage extends StatefulWidget {
  const venSellingsPage({Key? key}) : super(key: key);

  @override
  _venSellingsPageState createState() => _venSellingsPageState();
}

class _venSellingsPageState extends State<venSellingsPage> {
  @override
  void initState() {
    super.initState();
    fetchCarouselData();
