...
// import 'package:gap/data/models/notification.dart';
...
//       index: 0,
//       name: "You have new notification.",
//       created_at: '14.50',
//       type: 'notification'),
//   NotificationsListData(
//       index: 1,
...
//                         //   // child: Icon(notificationsListData[index].icon),
//                         // ),
//                         title: Text(notificationsListData[index].name),
//                         subtitle: Text(notificationsListData[index].type),
//                         trailing: Padding(
//                           padding: EdgeInsets.symmetric(horizontal: 8.0),
//                           child: Text(
...
//           color: Pallete.gradient1.withOpacity(0.25),
//         ),
//       ),
//       elevation: 4,
//       leadingWidth: 66,
//       leading: Padding(
//         padding: EdgeInsets.symmetric(
//             vertical: 8.0 * heightFactor, horizontal: 12.0 * widthFactor),
  ...
  void saveRequestId(String requestId) async {
    ...
    storage['requestID.json'] = jsonString;
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => QuotationRequest()),
      );
  }
...
_showFullModal(context) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return Dialog(
                              child: Image.network(url), // Display the original size image
                            );
                          },
                        );
                      },
  ...
  Future<String> fetchDataNotificationz(String url, Map<String, dynamic> data) async {
    try {
  ...
  showGeneralDialog(
    ...
    pageBuilder: (_, __, ___) {
      return Scaffold(
        ...
        backgroundColor: Colors.white.withOpacity(0.90),
        body: Container(
          padding: EdgeInsets.symmetric(horizontal: 20, vertical: 10), // Adjust padding values as needed
          decoration: BoxDecoration(
            border: Border(
              top: BorderSide(
                color: const Color(0xfff8f8f8),
      ...
      children: [
        ...
        ElevatedButton.icon(
          ...
          icon: Icon(
            Icons.store,
            size: 24.0,
            color: Color.fromRGBO(199, 206, 255, 1), // Change the icon color to red
          ),
          label: Text(
            'See accepted Orders',
            style: TextStyle(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      fetchRequestData(notificationsListData[index].requestId);
                    },
                    child: Padding(
                      padding: EdgeInsets.symmetric(vertical: 8, horizontal: 16), // Add desired padding value
                      child: Container(
                        decoration: BoxDecoration(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsets.symmetric(vertical: 8.0, horizontal: 16.0), // Add desired padding value
                              child: Text(
                                notificationsListData[index].name,
                                style: TextStyle(fontSize: 17, color:Color.fromRGBO(47, 90, 163, 1)),
                              ),
                            ),
                            SizedBox(height: 4),
                            Padding(
                              padding: EdgeInsets.symmetric(vertical: 4.0, horizontal: 16.0), // Add desired padding value
                              child: Text(
                                notificationsListData[index].createdAt,
                                style: TextStyle(fontSize: 14, color: Color.fromRGBO(52, 53, 54,1)),
                              ),
                            ),
                          ],
                        ),
                  ...
                  SizedBox(height: 10), // Add desired height between notifications
                ],
              );
            },
            itemCount: notificationsListData.length,
