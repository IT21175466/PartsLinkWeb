...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Future<String> fetchDataNotifications(String url, Map<String, dynamic> data) async {
    try {
      ...
      setState(() {
        notificationsListData = List<NotificationsListData>.from(
          data.map((notification) => NotificationsListData(
                ...
                type: 'notification',
                requestId: notification['request_id'], // Assign the value of 'request_id'
              )),
        );
      });
        ...
        setState(() {
          notificationsListData2 = List<NotificationsListData2>.from(
            data.map((notification) => NotificationsListData2(
                  ...
                  createdAt: notification['date_time'],
                  type: 'notification',
                  quotationID: notification['quotation_id'], // Assign the value of 'request_id'
                )),
          );
        });
  ...
  void saveRequestIdofNotify(String requestId) async {
    ...
    storage['notify_ID.json'] = jsonString;
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => editQuotationReqest()),
      );
  }
Future<void> approveTheOrder(paraReq) async {
  try {
    ...
    final dataSend = {
      'vID': paraReq,
      'text':'Your $partName - $partNo order which was sent in $dateTime has accepted.',
      'reqID':REQ,
    };
    final response = await http.post(Uri.parse(url), body: dataSend);
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => BuyerHomePage3()),
                  );
                },
              ),
            ],
                        ...
                        return InkWell(
                          onTap: () {
                            print(
                                ...
                                fetchQuotaDetail(notificationsListData2[index].quotationID);
      ...
      children: [
        ...
        Expanded(
          child: ListView.separated(
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      title: Padding(
                        padding: EdgeInsets.symmetric(vertical: 8.0, horizontal: 8.0), // Add padding to the title text
                        child: Text(
                      ...
                      subtitle: Padding(
                        padding: EdgeInsets.symmetric(vertical: 4.0, horizontal: 8.0), // Add padding to the subtitle text
                        child: Text(
                          notificationsListData[index].createdAt,
                          style: TextStyle(fontSize: 14, color: Color.fromRGBO(75, 76, 77,1)),
                        ),
                      ),
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              saveRequestIdofNotify(notificationsListData[index].requestId);
                            },
            ...
            separatorBuilder: (context, index) {
              return SizedBox(height: 10); // Add desired height between notifications
            },
