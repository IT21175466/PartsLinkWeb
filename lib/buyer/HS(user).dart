...
import 'package:gap/buyer/N(user).dart';
import 'package:gap/buyer/RP(user).dart';
...
class usSellingsPage extends StatefulWidget {
  const usSellingsPage({Key? key}) : super(key: key);

  @override
  _usSellingsPageState createState() => _usSellingsPageState();
}

class _usSellingsPageState extends State<usSellingsPage> {
  @override
  void initState() {
    super.initState();
    fetchCarouselData();
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton.extended(
            onPressed: () {
              Navigator.of(context).push(CupertinoPageRoute<void>(
                  builder: (BuildContext context) => RequestPart()));
            },
          ...
          FloatingActionButton.extended(
            ...
            backgroundColor: Color.fromARGB(255, 92, 35, 31),
          ),
        ],
      ),
    );
